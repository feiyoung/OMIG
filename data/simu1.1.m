...
clear;
% load ./gfmImpute/Rdata/simu1_misRate2mechMCARXlist.mat
...
qVec(i) = size(U1,2);
% run the following code to compile c function
% mex partXY.c
...
mean(meaMat)
save ./gfmImpute/Rdata/simu1_misRate2mechMNAR_PLAIS qVec meaMat
% save ./gfmImpute/Rdata/simu1_misRate2mechMCAR_PLAIS qVec meaMat
% save ./gfmImpute/Rdata/simu1_misRate1mechMAR_PLAIS qVec meaMat
...
load ./simu_R1/simuData_Mat/Rdata/simu1_misRate2mechMARXlist.mat
XmisCell = struct2cell(XmisList);
XCell =  struct2cell(XList);
clear XmisList XList
n  = length(XmisCell);
...
mean(meaMat)
save ./simu_R1/simuData_Mat/Mdata_R1/AE_simu1_misRate2mechMAR_PLAIS qVec meaMat
